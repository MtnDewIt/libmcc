...
#pragma pack(pop)
	...
	inline s_cache_file_tags_name** g_cache_file_tags_name() {
		return MODULE_GLOBAL(s_cache_file_tags_name*, hModule, s_data_offset_table::g_cache_file_tags_name);
	}

    inline s_cache_file_globals* g_cache_file_globals() {
        return MODULE_GLOBAL(s_cache_file_globals, hModule, s_data_offset_table::g_cache_file_globals);
    }
}
